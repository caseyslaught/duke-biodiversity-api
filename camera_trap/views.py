...
from camera_trap import serializers
...
class AddObservationView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        observation = CameraTrapObservation.objects.create(**data)

        photo_s3_object_key = f'{settings.S3_DATA_PREFIX}/camera_trap/{observation.uid}{o_ext}'
...
class GetObservationsView(generics.ListAPIView):
    ...
    def get_queryset(self):
        return CameraTrapObservation.objects.all()
